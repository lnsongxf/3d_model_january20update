...
set_nu=0.5; %SS*** penalty cost parameter,  appears in A1, C1 %67
 ...
 %interest stickiness
 %set_zeta_m=0.7942; %SS***  Interest rate stickiness, same as below, appears in  R_m R_F %59
%set_zeta_F=0.6141; %SS*** Interest rate stickiness,  appears in 51 FOC for bank business lending, 51 is not in use  %60
