...
set_tau_H=30; %SS*** elasticity of substitution for banks, appears in A1, B1, C1, D1, R_mi R_Fi %63
...
set_nu=0.5; %SS*** penalty cost parameter,  appears in A1, C1 %67
 ...
 %interest stickiness
 set_zeta_m=0.671965358496246; %SS***  Interest rate stickiness, same as below, appears in  R_m R_F %59
set_zeta_F=0.4121 ; %SS*** Interest rate stickiness,  appears in 51 FOC for bank business lending, 51 is not in use  %60
