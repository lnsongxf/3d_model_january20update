...
%     IRF(:,:,6,jj,ee,cc)=[Y_net_obs_epsiJ,I_obs_epsiJ,b_m_obs_epsiJ,b_e_obs_epsiJ]/100;      
     ...
     IRF(:,:,1,jj,ee,cc)=[Y_net_2_epsiA,I_epsiA,b_m_epsiA,b_e_epsiA,R_m_epsiA,R_F_epsiA];                       %IRF(irf_length,variable,shock,phi_Hs_grid,epsilonH1s_grid)
     IRF(:,:,2,jj,ee,cc)=[Y_net_2_epsiHd,I_epsiHd,b_m_epsiHd,b_e_epsiHd,R_m_epsiHd,R_F_epsiHd];                  
     IRF(:,:,3,jj,ee,cc)=[Y_net_2_epsiSm,I_epsiSm,b_m_epsiSm,b_e_epsiSm ,R_m_epsiSm,R_F_epsiSm];                                
     IRF(:,:,4,jj,ee,cc)=[Y_net_2_epsiHk,I_epsiHk,b_m_epsiHk,b_e_epsiHk,R_m_epsiHk,R_F_epsiHk];                
     IRF(:,:,5,jj,ee,cc)=[Y_net_2_epsiECAB,I_epsiECAB,b_m_epsiECAB,b_e_epsiECAB,R_m_epsiECAB,R_F_epsiECAB];            
     IRF(:,:,6,jj,ee,cc)=[Y_net_2_epsiJ,I_epsiJ,b_m_epsiJ,b_e_epsiJ,R_m_epsiJ,R_F_epsiJ];      
...
var_names={'Output','Investment','Business Debt','Household Debt','Mortgage Rate','Corporate Rate'};
