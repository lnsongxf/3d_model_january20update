...
pb_ratio_data-pb_mean=100*(1/ESB-1);
...
//shock_decomposition(first_obs=11,datafile='estimation_dataset_quarterly.mat',parameter_set=posterior_mode,use_shock_groups,init_state=0)
