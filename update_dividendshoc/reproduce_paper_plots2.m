...
irf1(:,:,1)=[b_m_obs_epsiA b_m_obs_epsiJ    b_m_obs_epsiEC b_m_obs_epsiECAB] ;
irf1(:,:,2)=[b_e_obs_epsiA b_e_obs_epsiJ     b_e_obs_epsiEC b_e_obs_epsiECAB] ;
irf1(:,:,3)=[R_m_obs_epsiA R_m_obs_epsiJ      R_m_obs_epsiEC R_m_obs_epsiECAB] ;
irf1(:,:,4)=[R_F_obs_epsiA R_F_obs_epsiJ       R_F_obs_epsiEC R_F_obs_epsiECAB] ;
irf1(:,:,5)=[Y_net_2_obs_epsiA Y_net_2_obs_epsiJ      Y_net_2_obs_epsiEC Y_net_2_obs_epsiECAB] ;
irf1(:,:,6)=[C_obs_epsiA C_obs_epsiJ       C_obs_epsiEC C_obs_epsiECAB] ;
irf1(:,:,7)=[q_H_obs_epsiA q_H_obs_epsiJ     q_H_obs_epsiEC q_H_obs_epsiECAB] ;
...
irf2(:,:,1)=[b_m_obs_epsiA b_m_obs_epsiJ    b_m_obs_epsiEC b_m_obs_epsiECAB] ;
irf2(:,:,2)=[b_e_obs_epsiA b_e_obs_epsiJ   b_e_obs_epsiEC b_e_obs_epsiECAB] ;
irf2(:,:,3)=[R_m_obs_epsiA R_m_obs_epsiJ    R_m_obs_epsiEC R_m_obs_epsiECAB] ;
irf2(:,:,4)=[R_F_obs_epsiA R_F_obs_epsiJ   R_F_obs_epsiEC R_F_obs_epsiECAB] ;
irf2(:,:,5)=[Y_net_2_obs_epsiA Y_net_2_obs_epsiJ  Y_net_2_obs_epsiEC Y_net_2_obs_epsiECAB] ;
irf2(:,:,6)=[C_obs_epsiA C_obs_epsiJ   C_obs_epsiEC C_obs_epsiECAB] ;
irf2(:,:,7)=[q_H_obs_epsiA q_H_obs_epsiJ     q_H_obs_epsiEC q_H_obs_epsiECAB] ;
%irf2(:,:,8)=[w_obs_epsiA w_obs_epsiJ w_obs_epsiSm   w_obs_epsiWe  w_obs_epsiHd w_obs_epsiHk w_obs_epsiEC w_obs_epsiECAB] ;
...
irf3(:,:,1)=[b_m_obs_epsiA b_m_obs_epsiJ b_m_obs_epsiEC b_m_obs_epsiECAB] ;
irf3(:,:,2)=[b_e_obs_epsiA b_e_obs_epsiJ   b_e_obs_epsiEC b_e_obs_epsiECAB] ;
irf3(:,:,3)=[R_m_obs_epsiA R_m_obs_epsiJ     R_m_obs_epsiEC R_m_obs_epsiECAB] ;
irf3(:,:,4)=[R_F_obs_epsiA R_F_obs_epsiJ     R_F_obs_epsiEC R_F_obs_epsiECAB] ;
irf3(:,:,5)=[Y_net_2_obs_epsiA Y_net_2_obs_epsiJ   Y_net_2_obs_epsiEC Y_net_2_obs_epsiECAB] ;
irf3(:,:,6)=[C_obs_epsiA C_obs_epsiJ   C_obs_epsiEC C_obs_epsiECAB] ;
irf3(:,:,7)=[q_H_obs_epsiA q_H_obs_epsiJ    q_H_obs_epsiEC q_H_obs_epsiECAB] ;
...
irf4(:,:,1)=[b_m_obs_epsiA b_m_obs_epsiJ   b_m_obs_epsiEC b_m_obs_epsiECAB] ;
irf4(:,:,2)=[b_e_obs_epsiA b_e_obs_epsiJ   b_e_obs_epsiEC b_e_obs_epsiECAB] ;
irf4(:,:,3)=[R_m_obs_epsiA R_m_obs_epsiJ    R_m_obs_epsiEC R_m_obs_epsiECAB] ;
irf4(:,:,4)=[R_F_obs_epsiA R_F_obs_epsiJ    R_F_obs_epsiEC R_F_obs_epsiECAB] ;
irf4(:,:,5)=[Y_net_2_obs_epsiA Y_net_2_obs_epsiJ    Y_net_2_obs_epsiEC Y_net_2_obs_epsiECAB] ;
irf4(:,:,6)=[C_obs_epsiA C_obs_epsiJ       C_obs_epsiEC C_obs_epsiECAB] ;
irf4(:,:,7)=[q_H_obs_epsiA q_H_obs_epsiJ   q_H_obs_epsiEC q_H_obs_epsiECAB] ;
%irf4(:,:,8)=[w_obs_epsiA w_obs_epsiJ w_obs_epsiSm   w_obs_epsiWe  w_obs_epsiHd w_obs_epsiHk w_obs_epsiEC w_obs_epsiECAB] ;
